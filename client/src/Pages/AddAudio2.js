...
export default class AddAudio2 extends React.Component {
...
//   }
  return (
        ...
        return ( */}
          <div className="AddAudio_box">
            ...
            <Form.Group controlId="formFile" className="mb-3">
                                ...
                                <Form.Control onChange={e=>this.handleFileChange(e)} type="file" />
                        </Form.Group>
                    {/* <input
                      name="file"
    ...
    <div className="AddAudioSubmit fw-bolder my-3">
      <button onClick={(e)=>this.handleSubmit(e)} className="btn btn-primary">Submit all Audios</button>
    </div>
    </>
  );
}
