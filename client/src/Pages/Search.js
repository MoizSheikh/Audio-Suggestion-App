...
export class Search extends React.Component {
    constructor(props){
        super(props);
        this.state={audio:{},audio2:{},searchTxt:'',searchTxt3:'',searchTxt4:'',searchTxt2:'' ,searchTxt5:'',searchTxt6:'', selectFlag : false,
        url:'',play: false,play2: false,msg:'',loading:false,loading2:false,replayFlag:false,apiUrl:'/api/get/',apiUrl2:'/api/get2/',dropdownValue:'none'}
...
<h2>Please Select Searches Type: </h2>
              ...
              <select name="SelectTable" id="SelectTable" className='selectTable' value={this.state.dropdownValue} onChange={this.handleDropDown}>
