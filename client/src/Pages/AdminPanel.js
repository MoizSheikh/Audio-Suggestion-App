        ...
        <div className="admin_container">
          ...
          <div className="tutorMain">
            ...
            <div className="d-flex addAudiosBtn justify-content-around">
              <a href="/addaudio" className="btn btn-success">
                Add Audio file DATABASE 1
              </a>
              <a href="/addaudio2" className="btn btn-success">
                Add Audio file DATABASE 2
              </a>
            </div>
            <hr />
                    ...
                    <div>
                      <Card className="admin_AudioList p-2 mx-1 mb-2">
                        ...
                        <div className="AdminBtns">
                          ...
                          <button
                            onClick={() => this.deleteAudio(eachAudio._id)}
                    ...
                    <div>
                      <Card className="admin_AudioList p-2 mx-1 mb-2">
                        ...
                        <div className="AdminBtns">
                          ...
                          <button
                            onClick={() => this.deleteAudio2(eachAudio._id)}
                            className="btn btn-danger"
                          >
                            Delete
                          </button>
