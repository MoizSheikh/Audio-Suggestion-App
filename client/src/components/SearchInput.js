...
export class SearchInput extends React.Component {
    ...
    constructor(props){
        super(props);
        this.state={audioData:[],searchTxt:'',searchTxt2:'',msg:'',audio:new Audio(),mainAudio:new Audio('mainaudio.mp3'),response:{},success:false}
                    ...
                    this.getAudioResponse(this.state.searchTxt2).then(callback2=>{
                        ...
                        if(callback2.succes && callback2.data){
                            ...
                            for(let i=0;i< this.state.searchTxt.length-1;i++){
                                var splitText=this.state.searchTxt.slice(0,this.state.searchTxt.length-(i+1));
...
validateFields(){
    ...
    render() {
        return (
            ...
            <input className="searchInputt1" value={this.state.searchTxt} onChange={this.handleSearch} type="text" htmlFor="searchWavInput" id="searchWavInput" placeholder="Search here"/>
            <input className="searchInputt1" value={this.state.searchTxt2} onChange={this.handleSearch2} type="text" htmlFor="searchWavInput2" id="searchWavInput2" placeholder="Search here secondary"/>
            <div>
